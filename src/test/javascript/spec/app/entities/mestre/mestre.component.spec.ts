...
import { MestreComponent } from 'app/entities/mestre/mestre.component';
import { MestreService } from 'app/entities/mestre/mestre.service';
import { Mestre } from 'app/shared/model/mestre.model';

describe('Component Tests', () => {
    describe('Mestre Management Component', () => {
        let comp: MestreComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MestreComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.mestres[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
