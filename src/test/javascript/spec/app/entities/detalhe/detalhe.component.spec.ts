...
describe('Component Tests', () => {
    describe('Detalhe Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.detalhes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
